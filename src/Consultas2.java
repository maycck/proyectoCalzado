...
public class Consultas2 {
	...
	public static String CompruebaImag(String campo,String tabla,String condicion,String value,Conexion c)
    {
        PreparedStatement pst= null;
        ResultSet rs=null;
        try{
        	
            String consulta="select "+campo+" from "+tabla+" where "+condicion+" like "+value;
            pst = c.getConexion().prepareStatement(consulta);
           // pst.setString(1, value);
	...
	public static String[][] RetornaArrayModelos(String tabla, String colum,Conexion c)
    {
        PreparedStatement pst= null;
        ResultSet rs=null;
        ArrayList<String> arr=new ArrayList<>();
...
//            pst.executeUpdate();
	...
	public static boolean InsertaDetallePedidoS(String tabla,int id,int id_detalle_pedido,String suela, String color,Conexion c)
	{
		PreparedStatement pst= null;
		try{
            String consulta="insert into "+tabla+" values (?,?,?,?)";
            pst = c.getConexion().prepareStatement(consulta);
            pst.setInt(1, id);
            pst.setInt(2, id_detalle_pedido);
            pst.setString(3, suela);
